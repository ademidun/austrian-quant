...
def value_find():
	...
	# use ensemble method of 4 classifiers
	clf = RandomForestClassifier()
	clf.learn(X,y)

	stock_dict = {stoc_ticker : 'probability',} # a dictionary of stock tickers and their corresponding buy probabilities

	for stock in sp500(1,250): # Top 250 by Market Cap
